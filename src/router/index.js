...
export const constantRoutes = [
  ...
  /*
  {
    ...
    component: (to) => {
      ...
      return cmsComponents[siteCode]?.() || import('@/views/error/401')},
    props: true, 
    hidden: true,  
    name: 'website',
  ...
  */
  {
    ...
    hidden: true,  
    name: 'webindex',
    meta: { title: 'web index'}
  },
  {
    path: '/web/search/:searchKey',
    component: () => import(/* webpackChunkName: "search" */'@/views/web/article/search'),
    props: true,
    hidden: true,  
    name: 'articleSearch',
    meta: { title: '搜索结果'}
  },
  {
    ...
    component: () => import(/* webpackChunkName: "info" */'@/views/web/article/info'),
    props: true,
    hidden: true,  
    name: 'articleInfo',
    meta: { title: '文章详情'}
  },
  {
    ...
    component: () => import(/* webpackChunkName: "more" */'@/views/web/article/more'),
    props: true,
    hidden: true,  
    name: 'articleMore',
    meta: { title: '文章列表'}
